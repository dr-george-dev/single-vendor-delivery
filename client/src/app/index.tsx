      ...
      <View className="mt-6">
        ...
        >
          {categories.map((cat, index) => (
            ...
            >
              <Text
                className={`${index === 0 ? "text-white" : "text-gray-600"} font-bold text-base`}
              >
                {cat}
              </Text>
            </TouchableOpacity>
        ...
        error ? (
          <View className="flex-1 justify-center items-center pt-10">
            ...
            <TouchableOpacity
              ...
              className="bg-orange-500 px-8 py-3 rounded-full shadow-sm"
            >
            ...
            {products.map((product: any) => (
              ...
              >
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-orange-500 font-extrabold text-lg">
